...
export default function Contact() {
  ...
  return (
    <section id="contact" className="px-6 md:px-10 py-24 md:py-36 bg-ink text-white">
        ...
        <div className="grid md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-5">
            ...
            <div className="mt-12 space-y-6 text-white/70">
              <div>
                <div className="text-xs uppercase tracking-[0.2em] font-mono text-white/50 mb-1">Email</div>
                <a
              ...
              <div>
                <div className="text-xs uppercase tracking-[0.2em] font-mono text-white/50 mb-1">Studio</div>
                <div className="text-xl">Chennai · Remote across Asia</div>
              </div>
              <div>
                <div className="text-xs uppercase tracking-[0.2em] font-mono text-white/50 mb-1">Hours</div>
